...
const createPaymentIntentInDb = async (payload) => {
    ...
    if (rentalOrder.OrderStatus !== OrderStatus.CONFIRMED) {
        throw new Error("You can only pay for orders that have been CONFIRMED by the provider.");
    }
...
const getMyPaymentHistoryFromDb = async (customerId) => {
...
const getPaymentDetailsByIdFromDb = async (paymentId, customerId) => {
