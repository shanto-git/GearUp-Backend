...
const getMyRentalIntoDb = async (customerId) => {
...
const getRentalByIdIntoDb = async (rentalId, customerId) => {
...
const getProviderIncomingOrderIntoDb = async (providerId) => {
    const result = await prisma.rentalOrder.findMany({
        where: {
            gearItem: {
...
const editRentalStatusIntoDb = async (rentalId, providerId, payload) => {
